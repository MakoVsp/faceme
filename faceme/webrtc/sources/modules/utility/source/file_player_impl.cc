...
//           printf("FilePlayerImpl::Get10msAudioFromFile() playing started!\
 codecFreq = %d, wantedFreq = %d\n",
 //          _codec.plfreq, frequencyInHz);
...
//	printf( "end of FilePlayerImpl::Get10msAudioFromFile outBuffer = %s \n", outBuffer );
    return 0;
}
...
{
		printf("FilePlayerImpl::StartPlayingFile\n");
 ...
 %s playout.", fileName);
	...
	printf("end of FilePlayerImpl::StartPlayingFile\n");
    return 0;
}
