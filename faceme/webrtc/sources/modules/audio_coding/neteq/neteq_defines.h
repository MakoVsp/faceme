...
#define NETEQ_LKX_SPEC_CODECS 1				// 自己定义的编解码
...
#if (defined(NETEQ_LKX_SPEC_CODECS))        /* 自定义 编解码（g711 ilbc） 音频处理（vad-Voice activity detection  cng-comfort noise generator RED-FEC前向纠错包格式） */
    #define NETEQ_G711_CODEC
    #define NETEQ_ILBC_CODEC
    #define NETEQ_VAD
    #define NETEQ_CNG_CODEC
