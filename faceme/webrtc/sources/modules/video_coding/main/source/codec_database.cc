    ...
    case VCM_VP8_IDX:
        {
            ...
            settings->codecSpecific.VP8.errorConcealmentOn = true;
			...
			settings->codecSpecific.VP8.pictureLossIndicationOn = true;
			settings->codecSpecific.VP8.complexity = kComplexityNormal;
            break;
        }
#endif
#ifdef VIDEOCODEC_I420
