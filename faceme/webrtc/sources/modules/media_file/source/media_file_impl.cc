...
WebRtc_Word32 MediaFileImpl::PlayoutAudioData(WebRtc_Word8* buffer,
                                WebRtc_UWord32& dataLengthInBytes)
{
//		printf("MediaFileImpl::PlayoutAudioData\n");
...
//	printf("MediaFileImpl::HandlePlayCallbacks\n");
}
    ...
    const WebRtc_UWord32 stopPointMs)
{
	...
	printf("MediaFileImpl::StartPlayingAudioFile\n");
    ...
    const WebRtc_UWord32 stopPointMs)
{
 ...
 be played");
	...
	printf("MediaFileImpl::StartPlayingFile :%s\n",_fileName);
    return 0;
}
