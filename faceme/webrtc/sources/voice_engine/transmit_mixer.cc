                                     ...
                                     const WebRtc_UWord32 durationMs)
{
    WEBRTC_TRACE(kTraceStream, kTraceVoice, VoEId(_instanceId, -1),
                 ...
                 printf("TransmitMixer::PlayNotification(id=%d, durationMs=%d)\n",
                 id, durationMs);
    // Not implement yet
}
                                       ...
                                       const WebRtc_UWord32 durationMs)
{
    WEBRTC_TRACE(kTraceStream, kTraceVoice, VoEId(_instanceId,-1),
                 ...
                 id, durationMs);
                 printf("TransmitMixer::RecordNotification(id=%d, durationMs=%d)\n",
                 id, durationMs);
...
void TransmitMixer::PlayFileEnded(const WebRtc_Word32 id)
{
    ...
    WEBRTC_TRACE(kTraceStateInfo, kTraceVoice, VoEId(_instanceId, -1),
                 ...
                 printf("TransmitMixer::PlayFileEnded() =>\n");
}
...
TransmitMixer::RecordFileEnded(const WebRtc_Word32 id)
{
    ...
    if (id == _fileRecorderId)
    {
        ...
        WEBRTC_TRACE(kTraceStateInfo, kTraceVoice, VoEId(_instanceId, -1),
                     ...
                     "is shutdown");
                     printf("TransmitMixer::RecordFileEnded() => fileRecorder module\n");
    } else if (id == _fileCallRecorderId)
    {
        ...
        WEBRTC_TRACE(kTraceStateInfo, kTraceVoice, VoEId(_instanceId, -1),
                     ...
                     "module is shutdown");
                     printf("TransmitMixer::RecordFileEnded() => fileCallRecorder\n");
    }
}
...
TransmitMixer::Create(TransmitMixer*& mixer, const WebRtc_UWord32 instanceId)
{
    ...
    if (mixer == NULL)
    {
        ...
        return -1;
                 ...
                 printf("TransmitMixer::Create(instanceId=%d)\n", instanceId);
    return 0;
}
...
TransmitMixer::RegisterVoiceEngineObserver(VoiceEngineObserver& observer)
{
    ...
    _voiceEngineObserverPtr = &observer;
            printf("RegisterVoiceEngineObserver() observer already enabled\n");
    return 0;
}
...
//		printf("_fileRecording\n");
    }

    // --- External media processing
//printf( "TransmitMixer::PrepareDemux: _externalMedia = %d, _externalMediaCallbackPtr = %d \n", _externalMedia, _externalMediaCallbackPtr );
    if (_externalMedia)
    {
        CriticalSectionScoped cs(&_callbackCritSect);
                                                ...
                                                const CodecInst* codecInst)
{
        ...
        (const CodecInst*) codecInst) != 0)
    {
        ...
        return -1;
            ...
            printf("StartPlayingFile() to start file playout\n");
...
int TransmitMixer::ScaleFileAsMicrophonePlayout(const float scale)
{
        ...
        (_filePlayerPtr->SetAudioScaling(scale) != 0))
    {
        ...
        return -1;
                 ...
                 printf("TransmitMixer::ScaleFileAsMicrophonePlayout(scale=%5.3f)\n",
                 scale);
    return 0;
}
                                      ...
                                      const CodecInst* codecInst)
{
    WEBRTC_TRACE(kTraceInfo, kTraceVoice, VoEId(_instanceId, -1),
                 ...
                 printf("TransmitMixer::StartRecordingCall(fileName=%s)\n", fileName);
    ...
    _fileCallRecording = true;
            ...
            printf("StartRecordingAudioFile() end\n");
    return 0;
}
    ...
    VoEMediaProcess& proccess_object)
{
    WEBRTC_TRACE(kTraceInfo, kTraceVoice, VoEId(_instanceId, -1),
                 ...
                 printf("TransmitMixer::RegisterExternalMediaProcessing()\n");
    ...
    const WebRtc_UWord32 mixingFrequency)
{
    ...
    if (_fileRecorderPtr->RecordAudioToFile(_audioFrame) != 0)
    {
        ...
        return -1;
             ...
             //        printf("TransmitMixer::RecordAudioToFile() file recording\n");
    return 0;
}
...
printf("TransmitMixer::MixOrReplaceAudioWithFile\n");
